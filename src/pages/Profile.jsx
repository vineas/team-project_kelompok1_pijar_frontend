      ...
      <div className="container" style={{ marginTop: 90 }}>
        <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-md-4 ">
                ...
                <div className="dropdown" style={{ display: "flex", justifyContent: "center" }}>
                  <a className="btn btn dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-expanded="false">
                    <img
                      src={edit}
                      type="button"
          ...
          <div className="col-md-12" style={{ marginTop: 50 }}>
            ...
            <div className="tab-content" id="nav-tabContent" style={{ marginTop: 20, paddingBottom: 60 }}>
              <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <img src={recipe1} alt="" style={{ width: "30%", marginRight: 30, marginTop: 30 }} />
                <img src={recipe2} alt="" style={{ width: "30%", marginRight: 30, marginTop: 30 }} />
                <img src={recipe1} alt="" style={{ width: "30%", marginRight: 30, marginTop: 30 }} />
                <img src={recipe2} alt="" style={{ width: "30%", marginRight: 30, marginTop: 30 }} />
                <img src={recipe1} alt="" style={{ width: "30%", marginRight: 30, marginTop: 30 }} />
                <img src={recipe2} alt="" style={{ width: "30%", marginRight: 30, marginTop: 30 }} />
