...
export const getRecipe = (setRecipe) => async (dispatch) => {
  try {
    axios.get("https://green-scorpion-boot.cyclic.app/recipes").then(function (respose) {
...
export const getDetailRecepe = (setRecipe, id) => async (dispatch) => {
  try {
    axios.get(`https://green-scorpion-boot.cyclic.app/recipes/${id}`).then((res) => {
...
export const createRecipe = (data, recipes_photo) => async (dispatch) => {
  try {
    ...
    console.log(data);
    axios
      .post("https://green-scorpion-boot.cyclic.app/recipes", formData, {
        headers: {
