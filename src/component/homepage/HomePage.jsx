  ...
  return (
    <>
      <style>
        ...
        {"}"}
        .newImg::before{"{"}
        content: ""; background-color: #efc81a; width: 414px; height: 490px; position: absolute; display: block; top: -20px; right: 440px; z-index: -1;
        {"}"}
        .eggImg::before{"{"}
        content: ""; background-color: #efc81a; position: absolute; display: block; width: 400px; height: 780px; top: -90px; left: 265px; z-index: -1;
        {"}"}
        {/* div {"{"}
        border: 1px solid;
        {"}"} */}
